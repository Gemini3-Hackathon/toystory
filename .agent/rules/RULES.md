...
복잡한 인증절차를 만들지 마세요. 이것은 MVP로, 기능을 보여주는 것이 목적이며 JWT등 보안 및 인증절차는 불필요합니다.
...
```
## 12. 깃허브 푸시
기능이 구현된 후에는 https://github.com/Gemini3-Hackathon/toystory.git 에 푸시를 진행해야해.
feature: 무슨무슨 기능
과 같은 형태로 진행.

## 13. 디자인 기획안을 따라줘.
/doc/design-spec.md 을 참고
